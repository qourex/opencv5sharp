...
namespace OpenCV5Sharp
{
    ...
    public partial class VideoCapture : DisposableOpenCVObject
    {
        ...
        /// <param name="apiPreference">preferred Capture API backends to use. Can be used to enforce a specific reader implementation if multiple are available: e.g. CAP_FFMPEG or CAP_IMAGES or CAP_DSHOW.</param>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        /// VideoCaptureAPIs
        /// </remarks>
        ...
        /// <param name="apiPreference">preferred Capture API backends to use. Can be used to enforce a specific reader implementation if multiple are available: e.g. CAP_DSHOW or CAP_MSMF or CAP_V4L.</param>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        /// VideoCaptureAPIs
        /// </remarks>
        ...
        /// <returns>`false` if no frames has been grabbed The method decodes and returns the just grabbed frame. If no frames has been grabbed (camera has been disconnected, or there are no more frames in video file), the method returns false and the function returns an empty image (with %Mat, test it with Mat.empty()).</returns>
        ...
        /// </summary>
        /// <param name="image">Input image.</param>
        /// <returns>`false` if no frames has been grabbed The method/function combines VideoCapture.grab() and VideoCapture.retrieve() in one call. This is the most convenient method for reading video files or capturing data from decode and returns the just grabbed frame. If no frames has been grabbed (camera has been disconnected, or there are no more frames in video file), the method returns false and the function returns empty image (with %Mat, test it with Mat.empty()).</returns>
        /// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
        /// <exception cref="ObjectDisposedException">Thrown when a parameter has been disposed.</exception>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        ...
        /// </summary>
        /// <param name="propId">Property identifier from VideoCaptureProperties (eg. CAP_PROP_POS_MSEC, CAP_PROP_POS_FRAMES, ...) or one from videoio_flags_others</param>
        ...
        /// </summary>
        /// <param name="propId">Property identifier from VideoCaptureProperties (eg. CAP_PROP_POS_MSEC, CAP_PROP_POS_FRAMES, ...) or one from videoio_flags_others</param>
        /// <returns>Value for the specified property. Value CAP_PROP_UNKNOWN is returned when querying a property that is not supported by the backend used by the VideoCapture instance.</returns>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Provides APIs for capturing video from cameras, video files, or image streams.
        /// </summary>
        /// <returns>The returned value.</returns>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
    ...
    public partial class VideoWriter : DisposableOpenCVObject
    {
        ...
        /// </summary>
        /// <param name="propId">Property identifier from VideoWriterProperties (eg. VIDEOWRITER_PROP_QUALITY) or one of videoio_flags_others</param>
        /// <param name="value">Value of the property.</param>
