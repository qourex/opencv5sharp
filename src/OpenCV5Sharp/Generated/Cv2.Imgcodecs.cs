...
namespace OpenCV5Sharp
{
    public static partial class Cv2
    {
            ...
            /// <param name="flags">Flag that can take values of ImreadModes, default with IMREAD_COLOR_BGR.</param>
            ...
            /// <param name="flags">Flag that can take values of ImreadModes.</param>
            /// <returns>The loaded image as a Mat object. If the image cannot be read, the function returns an empty matrix.</returns>
            /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
            /// <remarks>
            ...
            /// <see cref="Cv2.Imread(string, int)"/>
            /// </remarks>
            ...
            /// <param name="flags">Flag that can take values of ImreadModes, default with IMREAD_ANYCOLOR.</param>
            /// <returns>The returned value.</returns>
            /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
            /// <remarks>
            ...
            /// <param name="params">Optional format-specific parameters encoded as pairs (paramId_1, paramValue_1, paramId_2, paramValue_2, ...). These parameters are used to specify additional options for the encoding process. Refer to `ImwriteFlags` for details on possible parameters.</param>
            ...
            /// The default flags value was changed from IMREAD_ANYCOLOR to IMREAD_COLOR_BGR for unification.
            /// @todo when IMREAD_LOAD_GDAL flag used the return value will be 0 or 1 because OpenCV's GDAL decoder doesn't support multi-page reading yet.
            /// </remarks>
            ...
            /// <param name="params">Format-specific parameters encoded as pairs (paramId_1, paramValue_1, paramId_2, paramValue_2, ... .) see ImwriteFlags</param>
            ...
            /// <param name="metadataTypes">Output vector with types of metadata chucks returned in metadata, see ImageMetadataType</param>
            /// <param name="metadata">Output vector of vectors or vector of matrices to store the retrieved metadata</param>
            /// <param name="flags">Flag that can take values of ImreadModes.</param>
            /// <returns>The decoded image as a Mat object. If decoding fails, the function returns an empty matrix.</returns>
            /// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
            /// <exception cref="ObjectDisposedException">Thrown when a parameter has been disposed.</exception>
            /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
            /// <remarks>
            ...
            /// <param name="params">Format-specific parameters. See imwrite and ImwriteFlags.</param>
            /// <returns>The returned value.</returns>
            /// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
            /// <exception cref="ObjectDisposedException">Thrown when a parameter has been disposed.</exception>
            /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
            ...
            /// <see cref="Cv2.HaveImageWriter"/>, imread, imdecode
            /// </remarks>
            ...
            /// <see cref="Cv2.HaveImageReader"/>, imwrite, imencode
            /// </remarks>
