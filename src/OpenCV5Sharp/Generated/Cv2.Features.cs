...
namespace OpenCV5Sharp
{
    public static partial class Cv2
    {
        ...
        /// with qualityLevel=B .
        /// <see cref="Cv2.CornerMinEigenVal"/>, cornerHarris, calcOpticalFlowPyrLK, estimateRigidTransform,
        /// </remarks>
        ...
        /// <remarks>
        /// 
        /// For Python API, flags are modified as DRAW_MATCHES_FLAGS_DEFAULT,
        /// DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS, DRAW_MATCHES_FLAGS_DRAW_OVER_OUTIMG,
        ...
        /// <param name="flags">Flags setting drawing features. Possible flags bit values are defined by DrawMatchesFlags. This function draws matches of keypoints from two images in the output image. Match is a line connecting two keypoints (circles). See DrawMatchesFlags.</param>
        /// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
        /// <exception cref="ObjectDisposedException">Thrown when a parameter has been disposed.</exception>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
