...
namespace OpenCV5Sharp
{
    ...
    /// extractor, as described in [Zhao23] . It produces 128-dimensional float descriptors and
    ...
    public partial class Aliked : Feature2D
    {
        ...
        public static Aliked? Create(string modelPath, AlikedParams? @params)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.ALIKED_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class AlikedParams : DisposableOpenCVObject
    {
        ...
        {
            get { ThrowIfDisposed(); var res = NativeMethods.ALIKED_Params_inputSize_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.ALIKED_Params_inputSize_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the normalizeDescriptors property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool NormalizeDescriptors
        {
            get { ThrowIfDisposed(); var res = NativeMethods.ALIKED_Params_normalizeDescriptors_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.ALIKED_Params_normalizeDescriptors_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the engine property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public int Engine
        {
            get { ThrowIfDisposed(); var res = NativeMethods.ALIKED_Params_engine_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.ALIKED_Params_engine_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the backend property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public int Backend
        {
            get { ThrowIfDisposed(); var res = NativeMethods.ALIKED_Params_backend_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.ALIKED_Params_backend_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the target property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public int Target
        {
            get { ThrowIfDisposed(); var res = NativeMethods.ALIKED_Params_target_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.ALIKED_Params_target_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
    }
    ...
    public partial class ANNIndex : DisposableOpenCVObject
    {
        ...
        /// <param name="indices">Matrix that will contain the indices of the K-nearest neighbors found, optional.</param>
        /// <param name="dists">Matrix that will contain the distances to the K-nearest neighbors found, optional.</param>
        /// <param name="knn">Number of nearest neighbors to search for.</param>
        /// <param name="search_k">The maximum number of nodes to inspect, which defaults to trees x knn if not provided.</param>
        /// <exception cref="ArgumentNullException">Thrown when a required parameter is null.</exception>
        /// <exception cref="ObjectDisposedException">Thrown when a parameter has been disposed.</exception>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        ...
        /// <param name="prefault">If prefault is set to true, it will pre-read the entire file into memory (using mmap *  with MAP_POPULATE). Default is false.</param>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        ...
        /// *
        /// </summary>
        /// <param name="seed">The given seed of the random number generator. Its value should be within the range of uint32_t.</param>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        ...
        public static ANNIndex? Create(int dim, int distType)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.ANNIndex_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class AffineFeature : Feature2D
    {
        ...
        public static AffineFeature? Create(Feature2D backend, int maxTilt, int minTilt, float tiltStep, float rotateStepBase)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.AffineFeature_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class BFMatcher : DescriptorMatcher
    {
        ...
        public static BFMatcher? Create(int normType, bool crossCheck)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.BFMatcher_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class DescriptorMatcher : Algorithm
    {
        ...
        public DescriptorMatcher? Clone(bool emptyTrainData)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.DescriptorMatcher_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class FastFeatureDetector : Feature2D
    {
        ...
        public static FastFeatureDetector? Create(int threshold, bool nonmaxSuppression, int type)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.FastFeatureDetector_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class GFTTDetector : Feature2D
    {
        ...
        public static GFTTDetector? Create(int maxCorners, double qualityLevel, double minDistance, int blockSize, bool useHarrisDetector, double k)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.GFTTDetector_Delete(res);
                }
                throw;
            }
            finally
    ...
    /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
    /// <remarks>
    /// LightGlue is a CNN-based feature matcher, as described in [Lindenberger23] . It takes
    ...
    public partial class LightGlueMatcher : DescriptorMatcher
    {
        ...
        public static LightGlueMatcher? Create(string modelPath, float scoreThreshold, int backend, int target)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.LightGlueMatcher_Delete(res);
                }
                throw;
            }
            finally
    ...
    /// - the grey image algorithm is taken from: [nister2008linear] ;  the paper claims to be faster
    /// than union-find method; it actually get 1.5~2m/s on my centrino L7200 1.2GHz laptop.
    /// - the color image algorithm is taken from: [forssen2007maximally] ; it should be much slower
    ...
    /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
    /// <remarks>
    /// described in [RRKB11] . The algorithm uses FAST in pyramids to detect stable keypoints, selects
    ...
    public partial class SimpleBlobDetector : Feature2D
    {
        ...
        public static SimpleBlobDetector? Create(SimpleBlobDetectorParams? parameters)
        {
            ...
            catch
            {
                if (resultObj == null)
                {
                    NativeMethods.SimpleBlobDetector_Delete(res);
                }
                throw;
            }
            finally
    ...
    public partial class SimpleBlobDetectorParams : DisposableOpenCVObject
    {
        ...
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_thresholdStep_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_thresholdStep_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minThreshold property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinThreshold
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minThreshold_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minThreshold_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the maxThreshold property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MaxThreshold
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_maxThreshold_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_maxThreshold_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minRepeatability property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public long MinRepeatability
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minRepeatability_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minRepeatability_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minDistBetweenBlobs property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinDistBetweenBlobs
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minDistBetweenBlobs_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minDistBetweenBlobs_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the filterByColor property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool FilterByColor
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_filterByColor_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_filterByColor_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the blobColor property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public byte BlobColor
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_blobColor_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_blobColor_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the filterByArea property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool FilterByArea
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_filterByArea_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_filterByArea_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minArea property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinArea
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minArea_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minArea_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the maxArea property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MaxArea
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_maxArea_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_maxArea_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the filterByCircularity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool FilterByCircularity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_filterByCircularity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_filterByCircularity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minCircularity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinCircularity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minCircularity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minCircularity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the maxCircularity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MaxCircularity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_maxCircularity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_maxCircularity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the filterByInertia property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool FilterByInertia
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_filterByInertia_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_filterByInertia_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minInertiaRatio property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinInertiaRatio
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minInertiaRatio_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minInertiaRatio_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the maxInertiaRatio property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MaxInertiaRatio
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_maxInertiaRatio_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_maxInertiaRatio_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the filterByConvexity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool FilterByConvexity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_filterByConvexity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_filterByConvexity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the minConvexity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MinConvexity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_minConvexity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_minConvexity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the maxConvexity property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public float MaxConvexity
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_maxConvexity_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_maxConvexity_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
        /// <summary>Gets or sets the collectContours property.</summary>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        public bool CollectContours
        {
            get { ThrowIfDisposed(); var res = NativeMethods.SimpleBlobDetector_Params_collectContours_get(Handle); ErrorHelper.CheckError(); GC.KeepAlive(this); return res; }
            set { ThrowIfDisposed(); NativeMethods.SimpleBlobDetector_Params_collectContours_set(Handle, value); ErrorHelper.CheckError(); GC.KeepAlive(this); }
        }
    }
