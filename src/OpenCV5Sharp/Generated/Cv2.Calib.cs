...
namespace OpenCV5Sharp
{
    public static partial class Cv2
    {
        ...
        /// and @ref calibrateCamera returns bad values (zero distortion coefficients, [formula] and
        ...
        /// <param name="K">Output 3x3 floating-point camera intrinsic matrix [formula] . If @ref cv::CALIB_USE_INTRINSIC_GUESS is specified, some or all of fx, fy, cx, cy must be initialized before calling the function.</param>
        ...
        /// <param name="K1">Input/output first camera intrinsic matrix: [formula] , [formula] . If any of @ref cv::CALIB_USE_INTRINSIC_GUESS , @ref cv::CALIB_FIX_INTRINSIC are specified, some or all of the matrix components must be initialized.</param>
