...
namespace OpenCV5Sharp
{
    public static partial class Cv2
    {
        ...
        /// <param name="flags">Flags of the window. The supported flags are: (WindowFlags)</param>
        ...
        /// #pollKey.
        /// The functions #waitKey and #pollKey are the only methods in HighGUI that can fetch and handle
        /// GUI events, so one of them needs to be called periodically for normal event processing unless
        /// HighGUI is used within an environment that takes care of event processing.
        /// The function only works if there is at least one HighGUI window created and the window is
        ...
        /// This function should be followed by a call to waitKey or pollKey to perform GUI
        ...
        /// press (suitable for displaying a video frame-by-frame). To remove the window, use destroyWindow.
        ...
        /// [__Wayland Backend Only__] Supoorting format is extended.
        ...
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        /// [__Wayland Backend Only__] This function is not supported by the Wayland protocol limitation.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="winname">Name of the window.</param>
        /// <param name="prop_id">Window property to edit. The supported operation flags are: (WindowPropertyFlags)</param>
        /// <param name="prop_value">New value of the window property. The supported flags are: (WindowFlags)</param>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        /// The function setWindowProperty enables changing properties of a window.
        /// [__Wayland Backend Only__] This function is not supported.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="winname">Name of the window.</param>
        /// <param name="prop_id">Window property to retrieve. The following operation flags are available: (WindowPropertyFlags)</param>
        /// <returns>The returned value.</returns>
        /// <exception cref="OpenCVException">Thrown when the underlying OpenCV native call fails.</exception>
        /// <remarks>
        /// The function getWindowProperty returns properties of a window.
        /// <see cref="Cv2.SetWindowProperty"/>
        /// [__Wayland Backend Only__] This function is not supported.
        /// </remarks>
        ...
        /// <see cref="Cv2.ResizeWindow(string, int, int)"/> moveWindow
        /// [__Wayland Backend Only__] This function is not supported by the Wayland protocol limitation.
        /// </remarks>
        ...
        /// Controls: use `space` or `enter` to finish selection, use key `c` to cancel selection (function will return the zero Rect).
        /// The function sets it's own mouse callback for specified window using setMouseCallback(windowName, ...).
        ...
        /// <param name="weight">Font weight. Available operation flags are : QtFontWeights You can also specify a positive integer for better control.</param>
        /// <param name="style">Font style. Available operation flags are : QtFontStyles</param>
        ...
        /// created with the WINDOW_GUI_EXPANDED flags).
        /// </remarks>
